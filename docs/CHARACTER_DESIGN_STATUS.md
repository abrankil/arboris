...
El antiguo fondo `background-125x125.png` y el GIF de 125×125 fueron eliminados por resolución insuficiente. Los fondos ambientales se mantienen fuera de la galería de personajes y se versionan en `docs/assets/backgrounds/`, con variantes panorámicas y cuadradas HD-2D.

## Próximo punto de trabajo

Generar un wallpaper HD-2D de 500×500 px y separarlo en al menos tres capas de fondo, respetando la guía visual y sin mezclar personajes en las capas ambientales.
