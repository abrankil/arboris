...
**Estado:** CANDIDATO A INCORPORACIÓN  
**Versión:** R4 validada en alcance conceptual/UX  
...
## 18. Estado de incorporación

Este archivo documenta el artefacto validado para revisión de incorporación.

Todavía no decide:

- si este documento debe convertirse en autoridad normativa independiente;
- si debe integrarse parcialmente en `PRODUCT_VISION.md`, `PRODUCT_PRINCIPLES.md`, `GAMEPLAY_SYSTEMS_DIRECTION.md` o `FUNCTIONAL_REQUIREMENTS.md`;
- si el patrón se implementará en el Piloto 1.0.

Esas decisiones requieren un gate de incorporación separado conforme a `docs/DEVELOPMENT_MANUAL.md`.
