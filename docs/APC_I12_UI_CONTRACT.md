...
## 22. Integración con I11 R4

I12 no ejecuta identificación como efecto implícito de confirmar un dato.

Cuando se use I11 R4 como verificación desde la UI, debe ser una acción explícita, debe recibir la misma semántica externa de incompatibilidad del contexto writer y conservar exactamente la separación:
